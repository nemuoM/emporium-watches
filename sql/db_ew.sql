...
VALUES 
  ('https://tempusshop.imgix.net/kuoe-Old-smith-90-001-agd-s-br/001.jpg?w=960','KUOE KYOTO Old Smit', 'Le premier modèle de la marque, Old Smith, s''inspire des montres anciennes des années 1960. Un diamètre de 35 mm, avec son cadran ivoire, le modèle Old Smith donne une sensation unique et vintage associée aux montres classiques tannées.', 299.00, NOW(), RAND() * 20, 1, 3, 5, 1, 1, 1, 2),
  ('https://tempusshop.com/cdn/shop/products/orient-ra-as0102s10b_1280x.jpg?v=1671206062','Orient Moonphase Classic', 'La fonction Soleil & Lune illustre le passage du jour à la nuit sur un disque tournant de 24 heures, et le semi-squelette crée le style classique.Dotée d''un boîtier aminci, d''un verre bombé évoquant le style vintage et la chaleur, et d''un cadran combinant un beau motif soleillé avec des index à barres, elle renaît avec un nouveau style simple.', 329.00, NOW(), RAND() * 20, 2, 1, 2, 1, 2, 1, 3),
  ('https://images.ocarat.com/402464-thickbox_default/montre-mtgamma-blanc-bacb-maison-du-temps.jpg', 'MTGamma cadran blanc', 'La MTGamma est une source de détails horlogers.Votre affichage horaire ne cessera de vous surprendre. Vous trouverez, sur vos aiguilles, une trotteuse rouge, qui amplifiera votre satisfaction à chaque coup d’œil que vous jetterez sur votre garde temps.', 299.00, NOW(), RAND()*20, 3,1,2,3,1,1,1),
  ('https://tempusshop.com/cdn/shop/products/158349514-seiko-mechanical-limited-model-sarv001-1000x1000_960x.jpg?v=1671123134','Seiko Automatic date Kanji', '', 229.00, NOW(), RAND()*20, 4,1,4,1,2,1,6),
  ('https://tempusshop.com/cdn/shop/files/seiko-srk049p1_1280x.jpg?v=1695223789', 'Seiko petite seconde', 'Un design intemporel et sobre pour l''homme à la classe discrète. Ce garde-temps dégage un luxe distingué. Les aiguilles et les chiffres romains noirs sont montés sur un cadran blanc. Les secondes sont indiquées par une petite aiguille dans un cercle séparé au-dessus de la position 6 heures. Le bracelet en veau brun avec impression crocodile complète la montre et assure un ajustement parfait.', 230.00, NOW(), RAND()*20, 4,1,2,2,1,1,2),
  ('https://tempusshop.imgix.net/kuoe-Old-smith-90002-dgr/1.jpg?w=960', 'KUOE KYOTO Old Smith', 'Inspirée par les montres militaires britanniques des années 1940 - La collection Old Smith 90-002 de KUOE KYOTO recrée le design de l’époque avec un diamètre plus petit.', 399.00, NOW(), RAND()*20, 1,3,6,6,2,1,5),
  ('https://pbs.twimg.com/media/FfmAkLTXoAEv54J.jpg', 'Zentier Z2 Arabic dial', 'Limiter à 100 modèle dans le monde', 780.00, NOW(), RAND()*20, 6, 1,7,3,2,6,7),
  ('https://tempusshop.com/cdn/shop/files/tempusshop-lip-churchill-t18_1280x.png?v=1698045659', 'LiP T18 Churchill', 'Cette montre LIP T18 Churchill possède un charme vintage toujours d''actualité. Cette nouvelle version dotée d''un bracelet aux couleurs tendances, en fait un modèle souvent copié mais rarement égalé. La fabrication du calibre Type 18 débutera en 1935 juste avant la guerre 39-45. Durant ce conflit, l''entreprise déménage dans le centre de la France, puis au sud, à Valence. A la fin du conflit, LIP revient à Besançon et reconstruit son usine. La "T18" sort alors des ateliers. Calibre d''une grande modernité avec son petit compteur des secondes, un modèle tout en or est offert à Sir Winston Churchill en 1948.', 189.00, NOW(), RAND()*20, 5,2,4,1,1,6,2),
  ('https://images.ocarat.com/402527-thickbox_default/montre-mtbeta-skeletton-bacn-maison-du-temps.jpg', 'MTZeta skeletton', 'Plongez dans le monde la MTZeta de MaisonDuTemps. Arborant un boîtier en acier inoxydable de 42 mm et une lunette décagonale distinctive, cette montre allie précision japonaise Myiota 8N24 et esthétique sophistiquée. Avec verres en saphir, étanchéité à 100 mètres et choix de bracelets, la Zeta est un chef-d''œuvre intemporel.', 385.00, NOW(), RAND()*20, 3,1,10,3,2,1,7),
  ('https://tempusshop.com/cdn/shop/files/tempusshop-seiko-kinetic-SRN062P1_1280x.png?v=1692360355', 'Seiko KINETIC', '', 299.00, NOW(), RAND()*20, 4,1,3,8,4,1,2),
  ('https://tempusshop.imgix.net/Casio/G-shock/GA-2100/Tempusshop_Casio_Gshock_ga-2100-1aer.png?w=960', 'Casio G-Shock GA-2100', 'Les Casio G-SHOCK sont les montres parfaites pour partir à l''aventure ! Réputées indestructibles, ces montres ont de nombreuses fonctionnalités qui vous accompagnerons au quotidien.', 89.90, NOW(),RAND()*20, 8,3,1,4,1,11,3),
  ('https://tempusshop.imgix.net/Casio/G-shock/GMA/gma-s2100-4aer___web-removebg-preview.png?w=960', 'Casio G-Shock GMA-S2100', 'Cette série réduit la taille de la GA-2100 pour aboutir à un design simple et fin. Les caractéristiques spécifiques de la GA-2100 - lunette octogonale, cadran plat, index simples à trait large et structure Carbon Core Guard - sont désormais disponibles dans une configuration compacte.', 99.90, NOW(), RAND()*20, 8,3,11,4,1,11,3),
  ('https://tempusshop.imgix.net/Casio/G-shock/GMA/gma-s2100-7aer___print-removebg-preview.png?w=960', 'Casio G-Shock GMA-S2100', 'Cette série réduit la taille de la GA-2100 pour aboutir à un design simple et fin. Les caractéristiques spécifiques de la GA-2100 - lunette octogonale, cadran plat, index simples à trait large et structure Carbon Core Guard - sont désormais disponibles dans une configuration compacte.', 99.90, NOW(),RAND()*20,8,3,2,4,1,11,3),
  ('https://tempusshop.com/cdn/shop/products/A158WETG-9AEF_1280x.png?v=1667053719', 'Casio Vintage', 'Un classique que l''on ne présente plus.', 59.90, NOW(), RAND()*20, 8,3,12,1,6,3,6),
  ('https://tempusshop.com/cdn/shop/files/AG8M37X1-s1_960x.jpg?v=1686757082', 'ALBA bleu turquoise "Tiffany"', '', 170.00, NOW(), RAND()*20, 7,3,8,8,1,1,1),
  ('https://tempusshop.com/cdn/shop/products/Orient-sun-and-moon-blue-men-watch_960x.png?v=1669301005', 'Orient Moonphase bleu','La fonction Soleil & Lune illustre le passage du jour à la nuit sur un disque tournant de 24 heures, et le semi-squelette crée le style classique.Dotée d''un boîtier aminci, d''un verre bombé évoquant le style vintage et la chaleur, et d''un cadran combinant un beau motif soleillé avec des index à barres, elle renaît avec un nouveau style simple.', 329.00, NOW(), RAND() * 20, 2,1,3,1,2,1,2),
  ('https://tempusshop.com/cdn/shop/products/Orient-golde-eye-silver_1280x.png?v=1668536203', 'Orient Golden Eye', 'Orient Watch Company, plus communément appelée Orient est la plus grande entreprise japonaise de production de montres mécaniques, créée en 1950 par Shogoro Yoshida. Orient a la particularité de produire tous ses mouvements in-house. En 2009, Orient devient une filiale exclusive de Seiko.', 289.00, NOW(), RAND()*20, 2,1,4,2,2,1,1),
  ('https://tempusshop.com/cdn/shop/products/SSA423j1-seiko-presage_1280x.png?v=1666947292', 'Seiko présage', 'La nouvelle collection Presage Style 60''s reprend les caractéristiques du chronographe Crown avec un verre box-shaped, des index facettés et des aiguilles aux lignes acérées. Un design imprégné d’une sensation de douceur qui révèle un look vintage des années 60.', 590.00, NOW(), RAND()*20, 4,1,9,8,2,1,6),
  ('https://tempusshop.com/cdn/shop/products/AE-1000W-1AVEF_ee78ccef-09a3-45fb-ae88-125d681c8fe0_1280x.jpg?v=1676879902', 'Casio AE-1000W-1AVEF', 'Batterie avec 10 ans d''autonomie • Cadran similaire à un indicateur de planche de bord d''avion • Carte du monde pour l''heure mondiale • Écran analogique LC (heure de la ville de résidence) • Étanchéité jusqu''à 100 mètres', 39.90, NOW(), RAND()*20, 8,3,1,4,6,3,3),
  ('https://tempusshop.com/cdn/shop/files/tempusshop-casio-vintage-dbc-32d-1_1280x.jpg?v=1688463680', 'Casio Vintage DB', 'DATA BANK multilingue Cette montre numérique combinée à une calculatrice à 10 touches vous fait bénéficier de toute la commodité d''une calculatrice à 8 chiffres intégrée à une montre-bracelet. Son écran LCD à fort contraste facilite la lecture des chiffres. Parmi les autres fonctionnalités, citons le mode Banque de données, l''affichage du jour de la semaine en 13 langues et une autonomie de 10 ans garantissant un fonctionnement sans interruption.', 59.90, NOW(), RAND()*20, 8,3,4,1,6,3,1),
  ('https://tempusshop.com/cdn/shop/products/tempusshop-seiko-spb147-prospex_1280x.png?v=1675957493', 'Seiko Prospex', 'La montre automatique Prospex SPB147J1 est une ré-interprétation de la première montre Diver de 1965. Réalisée dans un acier inoxydable et étanche à 200 mètres, elle est la représentation parfaite du savoir-faire de la manufacture Seiko en matière de montres de plongée. Son joli cadran accueille des aiguilles et index revêtus de Lumibrite, son cadran est également recouvert d''un verre en saphir anti-reflet et entouré d''une lunette unidirectionnelle.', 990.0, NOW(), RAND()*20, 4,3,12,7,2,1,4);
