 ...
 * Class qui gère les interactions entre les clients de l'application et la bdd
 * 
 * @author M.MORABET
 * @date 12/2023
 */
 ...
 class ClientManager {
    ...
    /**
     * Tente de connecter un client en utilisant son adresse e-mail et mot de passe.
     * Établit une connexion à la base de données si elle n'est pas déjà établie.
     * Vérifie les informations de connexion fournies contre celles dans la base de données.
     * Si les informations sont correctes, initialise une session pour l'utilisateur et redirige vers l'URL du serveur.
     ...
     * Initialise une session pour le nouveau client et redirige vers une page de bienvenue.
     * 
